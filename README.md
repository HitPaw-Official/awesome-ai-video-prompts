...
### Seedance Prompts
- [Seedance Prompt Hub](./models/seedance/README.md)
- [Cinematic Seedance Prompts](./models/seedance/cinematic.md)
- [Anime Seedance Prompts](./models/seedance/anime.md)
- [Seedance Prompt Templates](./models/seedance/templates.md)

### Veo Prompts
- [Veo Prompt Hub](./models/veo/README.md)
- [Cinematic Veo Prompts](./models/veo/cinematic.md)
- [Veo Product Ad Prompts](./models/veo/ads.md)
- [Veo Prompt Templates](./models/veo/templates.md)
...
1. Pick a featured prompt or open a model hub.
2. Copy the prompt and adjust the subject, motion, and style.
3. Paste it into HitPaw AI Video Generator.
4. Refine and generate your video.

## FAQ

- [AI Video Prompts FAQ](./faq/ai-video-prompts-faq.md)
